Shader "Dummy Toon/Mobile/Toon Ramped"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _GUESSLIGHTDIR_ON
            ...
            v2f vert(appdata i)
            {
                ...
                // Use half lambert to get ramp UV's
                float dotProduct = dot(i.normal, lightDir) * 0.5 + 0.5;
                
                // Dot product is packed into Z of main UV's
                o.uv.z = dotProduct;
            ...
            fixed4 frag(v2f i) : SV_TARGET
            {
                ...
                // Multiply by the indirect lighting calculated in the vertex shader and add the ramp on top
                col.rgb *= i.lighting + (i.lightColor * tex2D(_Ramp, float2(i.uv.zz)).rgb);
