Shader "Dummy Toon/Mobile/Toon Sharp"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata i)
            {
                ...
                // Use half lambert to apply the lighting
                half dotProduct = dot(i.normal, lightDir) * 0.5 + 0.5;
                
                // Pack the lighting info into the output
                o.lighting.rgb = lighting;
                o.lighting.a = dotProduct;
            ...
            fixed4 frag(v2f i) : SV_TARGET
            {
                ...
                // Use stepped lambert to apply the lighting
                half3 lighting = i.lighting.rgb + (i.lightColor * (1 - step(i.lighting.a, 0.5)));
                
                // Multiply color by the lighting calculated
                col.rgb *= lighting;
