Shader "Dummy Toon/Toon Outline"
{
    Properties
    {
        ...
        [Toggle(_MAPPING_6_FRAMES_LAYOUT)] _ScreenSpaceOutline ("Screen-Space Outline", Float ) = 0
        ...
        [Toggle(_PARALLAXMAP)] _OutlineAlphaWidthEnabled ("Alpha Affects Width", Float) = 1
