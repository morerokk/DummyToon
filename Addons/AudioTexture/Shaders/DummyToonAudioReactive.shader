Shader "Dummy Toon/Addons/Toon (Audio Reactive)"
{
    Properties
    {
        ...
        // Audio texture
        _AudioTextureMask ("Audio Texture Mask", 2D) = "white" {}
        _AudioTextureSampleLocation ("Audio Texture Sample Location (XY)", Vector) = (0,0.36,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local _ _HUESHIFT_ON
            ...
            #include "Includes/DummyToonAudioTexture.cginc"
    ...
    CustomEditor "Rokk.DummyToon.Editor.DummyToonAudioTextureEditorGUI"
}
